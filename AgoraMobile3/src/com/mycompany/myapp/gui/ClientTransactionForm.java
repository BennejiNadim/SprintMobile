 ...
 * @author wmedi
 */
public class ClientTransactionForm extends Form {
    Form current;
    public ClientTransactionForm(Form previous, String username) {
        current=this;
        setTitle("User");
       
        ArrayList<Transaction> allTransaction = ServicesTransaction.getInstance().getClientTransaction();
